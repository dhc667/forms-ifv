...
function InlineInput({ className, type = 'text', ...props }: InlineInputProps) {
  return (
    <input
      ...
      className={cn(
        'border-input bg-input-background mx-1 inline-block h-8 max-w-50 min-w-15 rounded-md border px-2 py-1 text-sm transition-all duration-150 ease-out outline-none',
